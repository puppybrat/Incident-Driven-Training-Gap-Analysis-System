...
namespace Incident_Driven_Training_Gap_Analysis_System.Domain
{
    ...
    public class Incident
    {
        ...
        /// <summary>
        /// Gets or sets the identifier of the Standard Operating Procedure (SOP) associated with the incident.
        /// This property is nullable, indicating that an incident may not have an associated SOP.
        /// If a value is provided, it should be greater than 0 to be considered valid.
        /// </summary>
