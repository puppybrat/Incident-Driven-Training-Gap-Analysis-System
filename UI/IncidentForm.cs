...
namespace Incident_Driven_Training_Gap_Analysis_System.UI
{
    ...
    public partial class IncidentForm : UserControl
    {
        ...
        private void BuildLayout()
        {
            ...
            formLayout.Controls.Add(new Label() { Text = "Occurred At", AutoSize = true }, 0, 0);
            formLayout.Controls.Add(_dtpOccurredAt, 1, 0);

            formLayout.Controls.Add(new Label() { Text = "Shift", AutoSize = true }, 0, 1);
            formLayout.Controls.Add(_shiftPanel, 1, 1);

            formLayout.Controls.Add(new Label() { Text = "Line", AutoSize = true }, 0, 2);
            formLayout.Controls.Add(_linePanel, 1, 2);

            formLayout.Controls.Add(new Label() { Text = "Equipment", AutoSize = true }, 0, 3);
            formLayout.Controls.Add(_equipmentPanel, 1, 3);

            formLayout.Controls.Add(new Label() { Text = "SOP", AutoSize = true }, 0, 4);
            formLayout.Controls.Add(_cboSop, 1, 4);

            formLayout.Controls.Add(new Label(), 0, 5);
            formLayout.Controls.Add(_btnCreate, 1, 5);

            formLayout.Controls.Add(new Label(), 0, 6);
            formLayout.Controls.Add(_btnClear, 1, 6);
